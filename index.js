...
*/
exports.genString = (length, characters = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789') => {
   let result = '';
...
*/
exports.genStrings = (count, length, characters = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789') => {
    let i;
    let strings = []
    for (i = 0; i < count; i++) {
        let result = '';
